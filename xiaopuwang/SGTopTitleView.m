...
#define labelFontOfSize [UIFont systemFontOfSize:12]
...
- (void)setStaticTitleArr:(NSArray *)staticTitleArr {
    ...
    for (NSInteger j = 0; j < self.staticTitleArr.count; j++) {
        ...
        _staticTitleLabel.font = [UIFont systemFontOfSize:13.0];
        // 设置高亮文字颜色
...
- (void)setScrollTitleArr:(NSArray *)scrollTitleArr {
    ...
    CGFloat scrollViewWidth = CGRectGetMaxX(lastView.frame);
